...
bool checkValidCourse (string courseName)
{
    ifstream fin ("Src/FileCSV/StudentInCourse.csv");
...
void StaffSearchCourseScreen (RenderWindow &app, string idInput, string passwordInput)
{
    string inputTmp;
    int check = 0;
    ...
    while (app.isOpen ()){
        ...
        while (app.pollEvent (e)){
            ...
            else if (e.type == sf::Event::KeyPressed && e.key.code == sf::Keyboard::Enter)
            {
                ...
                check = 0;
                if (checkValidCourse(inputTextCourse.getString())) {
                    StudentListinCourseScreen (app, inputTextCourse.getString(), idInput, passwordInput);
                }
                else {
                    invalidWarning.setString("Wrong id or password!");
                    inputTmp = "";
                    inputTextCourse.setString("");
                }
            }
