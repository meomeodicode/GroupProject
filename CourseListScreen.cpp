...
void CourseListScreen(RenderWindow &app, string idInput, string passwordInput)
{
    // Font
    Font font;
    ...
    // Read file
    ifstream fin("Src/FileCSV/courselist.csv");
    string line;
    Text courselist("",font,25);
    courselist.setPosition(200,200);
