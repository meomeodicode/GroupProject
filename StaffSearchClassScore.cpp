...
void StaffSearchClassScoreScreen (RenderWindow &app, string idInput, string passwordInput)
{
    string inputTmp;
    int check = 0;
    ...
    Text inputTextCourse ("Please enter your class", font, 25);
        ...
        while (app.pollEvent (e)){
            ...
            else if (e.type == sf::Event::KeyPressed && e.key.code == sf::Keyboard::Enter)
            {
                ...
                if (inputTextCourse.getString() != "Please enter your class") {
                    //CourseScoreScreen (app, inputTextCourse.getString());
                }
            }
